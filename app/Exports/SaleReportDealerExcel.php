...
class SaleReportDealerExcel implements ShouldAutoSize, FromView, WithEvents
{
  use Exportable;
  ...
  {
    $this->rows = Transaction::reportDealerLists($this->filter);
    $this->rowCount = count($this->rows);

    $this->total_by_currency = Transaction::getTotalByCurrencyForDealer($this->filter);
    $this->total_by_bank = Transaction::getTotalByBankForDealer($this->filter);
    $this->total_debt = Transaction::getTotalDealerDebt($this->filter);
  }
  ...
  {
    return view('prints.excel.sale_report_dealer_excel', [
      'filter' => $this->filter,
      'data' => $this->rows,
