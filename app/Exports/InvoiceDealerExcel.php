...
class InvoiceDealerExcel implements ShouldAutoSize, FromView, WithEvents
{
  use Exportable;
  ...
  {
    $this->rows =Transaction::listsForDealer($this->filter)->get();
  ...
  public function view(): View
  {
    ...
    $data = $this->rows;
    $filter = $this->filter;
    return view('prints.excel.invoice_dealer_list_excel', [
      'filter' => $filter,
      'data' => $data,
    ]);
  }
