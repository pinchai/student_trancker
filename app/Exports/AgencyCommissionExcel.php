...
class AgencyCommissionExcel implements ShouldAutoSize, FromView, WithEvents
{
  use Exportable;
  ...
  {
    $this->rows = TransactionAgency::listCommission($this->filter);;
  ...
  public function view(): View
  {
    $data = $this->rows;
    $filter = $this->filter;
    return view('prints.excel.agency_commission_excel', [
      'filter' => $filter,
      'data' => $data,
    ]);
  }
