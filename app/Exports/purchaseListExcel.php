...
class purchaseListExcel implements ShouldAutoSize, FromView, WithEvents
{
  use Exportable;
  ...
  {
    $this->rows =Transaction::listsPurchase($this->filter)->get();
  ...
  public function view(): View
  {
    ...
    $data = $this->rows;
    $filter = $this->filter;
    return view('prints.excel.purchase_list_excel', [
      'filter' => $filter,
      'data' => $data,
    ]);
  }
