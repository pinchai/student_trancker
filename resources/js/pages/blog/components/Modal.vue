<template>
  ...
  >
    <template slot="modal-header">
      <h3><i class="fas fa-warehouse"></i> {{ $t("blog") }}</h3>
    </template>
    <b-row>
      <!--select image-->
        ...
        <b-row>
          ...
          <b-col cols="12">
            <b-card no-body class="shadow-sm mt-3">
              <b-card-header>
                <b-row>
                  <b-col cols="6"><h3 class="info-title">{{ $t("short_description") }}</h3></b-col>
                  <b-col cols="6">
                    <b-button v-b-toggle.collapse-description class="float-right m-1">Toggle How To Short Description</b-button>
                  </b-col>
                </b-row>
              </b-card-header>
              <b-card-body>
                <b-row>
                  ...
                  <b-col cols="12">
                    <b-collapse visible id="collapse-description">
                      <text-editor
                              :setText="form.short_description"
                              @getText="getShortDescriptionText"
                      ></text-editor>
                    </b-collapse>
                  </b-col>
                </b-row>
