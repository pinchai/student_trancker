        ...
        <b-row>
          <b-col cols="12" xl="6">
            ...
            <b-button
              ...
              v-if="checkAuthorize($store.state.permission.delete) && false"
              class="mb-2"
            >
        ...
        <b-row>
          <b-col cols="12">
            <b-table
              ...
              small
            >
              <template #cell(send_notify)="row">
                <b-button
                  variant="outline-primary"
                  @click="sendTest(row.item.bot_toked, row.item.chat_id)"
                >
  ...
  computed: {
    ...
    header() {
      return [
        ...
        {
          key: "bot_toked",
          label: this.$t("bot_toked"),
          sortable: true
        },
        {
          key: "chat_id",
          label: this.$t("chat_id"),
          sortable: true
        },
        {
          key: "action",
    ...
    deleteItem() {
      this.$fire({
        ...
        if (result.value) {
          let vm = this;
          axios
            .post("/telegram_bot/delete", {id: this.selectedItem.id})
            .then(function (response) {
              vm.$store.dispatch(
                "setCustomer",
